...
const LineChart = () => {
  ...
  // Hardcoded data representing message reach per time
  const data = [
    { time: '00:00', reach: 300 },
    { time: '01:00', reach: 150 },
    { time: '02:00', reach: 200 },
    { time: '03:00', reach: 180 },
    { time: '04:00', reach: 500 },
    { time: '05:00', reach: 400 },
    { time: '06:00', reach: 600 },
    { time: '07:00', reach: 800 },
    { time: '08:00', reach: 1200 },
  ];
    ...
    <ChartContainer className={theme}>
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          />
          <YAxis
            label={{ value: 'Message Reach', angle: -90, position: 'insideLeft', offset: 10 }}
            tick={{ fill: "var(--axis-color)", fontSize: '0.8em' }}
          />
          <Tooltip
