...
// Hardcoded data for the leaderboard of top organizers
const leaderboardData = [
  { userId: 1, userName: 'Alice', eventCount: 35 }, // Number of events organized
  { userId: 2, userName: 'Bob', eventCount: 30 },
  { userId: 3, userName: 'Charlie', eventCount: 28 },
  { userId: 4, userName: 'David', eventCount: 25 },
  { userId: 5, userName: 'Eve', eventCount: 20 },
  { userId: 6, userName: 'Frank', eventCount: 18 },
  { userId: 7, userName: 'Grace', eventCount: 15 },
  { userId: 8, userName: 'Heidi', eventCount: 12 },
  { userId: 9, userName: 'Ivan', eventCount: 10 },
  { userId: 10, userName: 'Judy', eventCount: 8 },
];
...
const TopOrganizersLeaderboard = () => {
  // Ensure data is sorted by event count in descending order
        ...
        <Table stickyHeader> {/* Enable sticky header for the table */}
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">Events Organized</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {topUsers.map((user, index) => (
              ...
              >
                ...
                <TableCell align="right">{user.eventCount}</TableCell>
              </StyledTableRow>
            ))}
          </TableBody>
        </Table>
...
export default TopOrganizersLeaderboard;
