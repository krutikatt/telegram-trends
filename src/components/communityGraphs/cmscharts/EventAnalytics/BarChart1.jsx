...
const DailyActivityChart = ({
  ...
  data = [],   // Data representing the daily activity for each day
  isDashboard = false,
          ...
          options={{
            ...
            plugins: {
              ...
              tooltip: {
                callbacks: {
                  label: (tooltipItem) => {
                    return `Activity: ${tooltipItem.raw}`; // Tooltip showing activity count
                  },
                },
              },
            },
            scales: {
              x: {
                title: {
                  display: true,
                  text: "Days", // X-axis representing days
                },
                grid: {
                  display: false,
                },
              ...
              y: {
                title: {
                  display: true,
                  text: "Activity", // Y-axis label for activity levels
                },
                beginAtZero: true,
                grid: {
