...
const DailyPromotedEventsChart = ({
  labels = [], // Labels representing the days of the week or specific dates
  data = [],   // Data representing the number of promoted events for each day
  isDashboard = false,
          ...
          options={{
            ...
            plugins: {
              ...
              tooltip: {
                callbacks: {
                  label: (tooltipItem) => {
                    return `Promoted Events: ${tooltipItem.raw}`; // Tooltip for promoted events
                  },
                },
              },
            },
            scales: {
              x: {
                title: {
                  display: true,
                  text: "Days", // X-axis label for days
                },
                grid: {
                  display: false,
                },
              ...
              y: {
                title: {
                  display: true,
                  text: "Promoted Events", // Y-axis label
                },
                beginAtZero: true,
                grid: {
...
export default DailyPromotedEventsChart;
