...
const EffectivenessOfRemindersChart = ({
  labels = [], // Labels representing the days of the week or specific dates
  data = [],   // Data representing the effectiveness of reminders for each day
  isDashboard = false,
          ...
          options={{
            ...
            plugins: {
              ...
              tooltip: {
                callbacks: {
                  label: (tooltipItem) => {
                    return `Effectiveness Score: ${tooltipItem.raw}`; // Tooltip for effectiveness
                  },
                },
              },
            },
            scales: {
              x: {
                title: {
                  display: true,
                  text: "Reminders", // X-axis label for days
                },
                grid: {
                  display: false,
                },
              ...
              y: {
                title: {
                  display: true,
                  text: "Effectiveness Score", // Y-axis label
                },
                beginAtZero: true,
                grid: {
...
export default EffectivenessOfRemindersChart;
