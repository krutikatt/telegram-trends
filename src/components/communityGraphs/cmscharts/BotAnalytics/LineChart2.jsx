...
const LineChart = () => {
  ...
  // Updated hardcoded data for bot activity (e.g., messages sent)
  const data = [
    { hour: '00:00', activity: 10 },
    { hour: '01:00', activity: 15 },
    { hour: '02:00', activity: 25 },
    { hour: '03:00', activity: 30 },
    { hour: '04:00', activity: 45 },
    { hour: '05:00', activity: 50 },
    { hour: '06:00', activity: 75 },
    { hour: '07:00', activity: 90 },
    { hour: '08:00', activity: 120 }
  ];
    ...
    <ChartContainer className={theme}>
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          />
          <YAxis
            label={{ value: 'Bot Activity', angle: -90, position: 'insideLeft', offset: 10 }}
            tick={{ fill: "var(--axis-color)", fontSize: '0.8em' }}
          />
          <Tooltip
          ...
          <Line
            type="monotone"
            dataKey="activity" // Change the data key to "activity"
