...
const RepliesCountChart = ({
  labels = [], // Labels representing days or time periods
  data = [],   // Data representing the total replies count
  isDashboard = false,
          ...
          options={{
            ...
            plugins: {
              ...
              tooltip: {
                callbacks: {
                  label: (tooltipItem) => {
                    return `Total Replies: ${tooltipItem.raw}`; // Tooltip for total replies count
                  },
                },
              },
            },
            scales: {
              x: {
                title: {
                  display: true,
                  text: "Time Periods", // X-axis label updated to reflect the context
                },
                grid: {
                  display: false,
                },
              ...
              y: {
                title: {
                  display: true,
                  text: "Total Replies", // Y-axis label updated
                },
                beginAtZero: true,
                grid: {
...
export default RepliesCountChart;
