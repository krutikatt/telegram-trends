...
const MostActiveDaysChart = ({
  labels = [], // Labels representing days of the week
  data = [],   // Data representing activity volume per day
  isDashboard = false,
          ...
          options={{
            ...
            plugins: {
              ...
              tooltip: {
                callbacks: {
                  label: (tooltipItem) => {
                    return `Total Activity: ${tooltipItem.raw}`; // Tooltip for total activity per day
                  },
                },
              },
            },
            scales: {
              ...
              y: {
                title: {
                  display: true,
                  text: "Total Activity", // Y-axis label updated
                },
                beginAtZero: true,
                grid: {
...
export default MostActiveDaysChart;
