...
const LineChart = () => {
  ...
  // Updated hardcoded data for anonymous messages volume over time
  const data = [
    { hour: '00:00', volume: 10 },
    { hour: '01:00', volume: 15 },
    { hour: '02:00', volume: 20 },
    { hour: '03:00', volume: 25 },
    { hour: '04:00', volume: 30 },
    { hour: '05:00', volume: 35 },
    { hour: '06:00', volume: 40 },
    { hour: '07:00', volume: 45 },
    { hour: '08:00', volume: 50 }
  ];
    ...
    <ChartContainer className={theme}>
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          />
          <YAxis
            label={{ value: ' Messages', angle: -90, position: 'InsideLeftCenter', offset: 10 }}
            tick={{ fill: "var(--axis-color)", fontSize: '0.8em' }}
          />
          <Tooltip
