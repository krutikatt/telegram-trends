...
const LineChart = () => {
  ...
  // Updated data: number of active users at each hour
  const data = [
    { hour: '00:00', activeUsers: 8 },
    { hour: '01:00', activeUsers: 3 },
    { hour: '02:00', activeUsers: 6 },
    { hour: '03:00', activeUsers: 5 },
    { hour: '04:00', activeUsers: 12 },
    { hour: '05:00', activeUsers: 11 },
    { hour: '06:00', activeUsers: 18 },
    { hour: '07:00', activeUsers: 22 },
    { hour: '08:00', activeUsers: 35 }
  ];
