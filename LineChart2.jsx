...
const LineChart = () => {
  ...
  // Hardcoded data representing average replies per message over time
  const data = [
    { time: '00:00', repliesPerMessage: 2.5 },
    { time: '01:00', repliesPerMessage: 1.2 },
    { time: '02:00', repliesPerMessage: 1.8 },
    { time: '03:00', repliesPerMessage: 1.5 },
    { time: '04:00', repliesPerMessage: 3.0 },
    { time: '05:00', repliesPerMessage: 2.7 },
    { time: '06:00', repliesPerMessage: 4.0 },
    { time: '07:00', repliesPerMessage: 5.0 },
    { time: '08:00', repliesPerMessage: 6.0 },
  ];
    ...
    <ChartContainer className={theme}>
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          />
          <YAxis
            label={{ value: 'Replies per Message', angle: -90, position: 'insideLeft', offset: 10 }}
            tick={{ fill: "var(--axis-color)", fontSize: '0.8em' }}
          />
          <Tooltip
