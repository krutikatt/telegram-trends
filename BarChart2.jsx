...
const MessagePerformanceChart = ({
  ...
  data = [],   // Data representing engagement per message
  isDashboard = false,
          ...
          options={{
            ...
            plugins: {
              ...
              tooltip: {
                callbacks: {
                  label: (tooltipItem) => {
                    return `Engagement: ${tooltipItem.raw}`; // Tooltip for engagement per message
                  },
                },
              },
            },
            scales: {
              ...
              y: {
                title: {
                  display: true,
                  text: "Engagement", // Y-axis label updated to Engagement
                },
                beginAtZero: true,
                grid: {
